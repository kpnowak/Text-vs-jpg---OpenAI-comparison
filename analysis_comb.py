...
with open('review_comb_10_non-prom\\output_only_text1.txt', 'r', encoding='latin-1') as file:
    output_only_text1 = file.read()

with open('review_comb_10_non-prom\\output_only_text2.txt', 'r', encoding='latin-1') as file:
    output_only_text2 = file.read()

with open('review_comb_10_non-prom\\output_only_text3.txt', 'r', encoding='latin-1') as file:
    output_only_text3 = file.read()

with open('review_comb_10_non-prom\\output_only_text4.txt', 'r', encoding='latin-1') as file:
    output_only_text4 = file.read()

with open('review_comb_10_non-prom\\output_only_text5.txt', 'r', encoding='latin-1') as file:
    output_only_text5 = file.read()

with open('review_comb_10_non-prom\\output_only_text6.txt', 'r', encoding='latin-1') as file:
    output_only_text6 = file.read()

with open('review_comb_10_non-prom\\output_only_text7.txt', 'r', encoding='latin-1') as file:
    output_only_text7 = file.read()

with open('review_comb_10_non-prom\\output_only_text8.txt', 'r', encoding='latin-1') as file:
    output_only_text8 = file.read()

with open('review_comb_10_non-prom\\output_only_text9.txt', 'r', encoding='latin-1') as file:
    output_only_text9 = file.read()

with open('review_comb_10_non-prom\\output_only_text10.txt', 'r', encoding='latin-1') as file:
    output_only_text10 = file.read()

#-------------------------------------------------------------------------------------------------------------------------
#----------------------------------------- IMAGE -------------------------------------------------------------------------
#-------------------------------------------------------------------------------------------------------------------------

with open('review_comb_10_non-prom\\output_with_image1.txt', 'r', encoding='latin-1') as file:
    output_with_image1 = file.read()

with open('review_comb_10_non-prom\\output_with_image2.txt', 'r', encoding='latin-1') as file:
    output_with_image2 = file.read()

with open('review_comb_10_non-prom\\output_with_image3.txt', 'r', encoding='latin-1') as file:
    output_with_image3 = file.read()

with open('review_comb_10_non-prom\\output_with_image4.txt', 'r', encoding='latin-1') as file:
    output_with_image4 = file.read()

with open('review_comb_10_non-prom\\output_with_image5.txt', 'r', encoding='latin-1') as file:
    output_with_image5 = file.read()

with open('review_comb_10_non-prom\\output_with_image6.txt', 'r', encoding='latin-1') as file:
    output_with_image6 = file.read()

with open('review_comb_10_non-prom\\output_with_image7.txt', 'r', encoding='latin-1') as file:
    output_with_image7 = file.read()

with open('review_comb_10_non-prom\\output_with_image8.txt', 'r', encoding='latin-1') as file:
    output_with_image8 = file.read()

with open('review_comb_10_non-prom\\output_with_image9.txt', 'r', encoding='latin-1') as file:
    output_with_image9 = file.read()

with open('review_comb_10_non-prom\\output_with_image10.txt', 'r', encoding='latin-1') as file:
    output_with_image10 = file.read()
...
def analysis_txt():
    ...
    with open("Comb_non-prom\\analysis_txt3.txt", "w") as f:
...
def analysis_jpg():
    ...
    with open("Comb_non-prom\\analysis_jpg3.txt", "w") as f:
        f.write(response.choices[0].message.content)
